    ...
    public function index()
    {
      // Konfigurasi email
        $config = [
            ...
            'smtp_user' => 'marwahzulfannya@gmail.com',  // Email gmail
            'smtp_pass'   => 'mrngglry4675',  // Password gmail
            'smtp_crypto' => 'ssl',
            'smtp_port'   => 465,
            'crlf'    => "\r\n",
            'newline' => "\r\n"
        ...
        $this->email->from('marwahzulfannya', 'Fanny');

        // Email penerima
        $this->email->to('marwahzulfannya@gmail.com'); // Ganti dengan email tujuan
